...
/// Determine how many lines the status bar needs based on terminal width
fn status_bar_height(app: &App, width: u16) -> u16 {
    ...
    // If full status + help fits on one line, use 1 line
    // Otherwise use 2 lines (branch+help on line 1, stats on line 2)
